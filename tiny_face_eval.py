...
def evaluate(weight_file_path, data_dir, output_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
    ...
    with tf.Session() as sess:
        ...
        for filename in filenames:
            ...
            out_path = output_dir + '/' + fname.split('.')[0] + '/'
            if not os.path.exists(out_path):
                os.makedirs(out_path)
            cut_img = cv2.cvtColor(raw_img, cv2.COLOR_RGB2BGR)
            cut_bounding_boxes(cut_img, refined_bboxes, out_path)
...
def main():
    ...
    argparse.add_argument('--data_dir', type=str, help='Image data directory.', default="./input_images")
